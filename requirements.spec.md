...
The value is a set of key values with some details about the post including the key `timestamp` representing the creation date of the post encoded as a *UNIX* timestamp
...
For each post type (cf. Structure of the paylaod), display one instance of the visualization along with a counter of the number of posts processed.
